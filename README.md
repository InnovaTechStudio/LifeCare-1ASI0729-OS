# Documentación del Trabajo Final - 1ASI0729 <!-- omit in toc -->

<div align="center">
  
![logo](assets/READMEmedia/upclogo.png)<br>
    ...
    <tbody>
      ...
      <tr>
        <td style="padding: 20px; border: 1px solid #ddd; vertical-align: middle; text-align: left;">
          ...
          <i>Estoy cursando el quinto ciclo de mi carrera. A lo largo de mi experiencia aprendí muchas cosas como ser una persona proactiva, perseverante y responsable. Mediante mi conocimiento sé que puedo aportar más de mis capacidades para presentar un buen proyecto en equipo. <br></i>
        </td>
        <td style="padding: 10px; border: 1px solid #ddd; text-align: center; vertical-align: middle;">
...
**ENTREVISTA 1: Técnico Independiente**
    ...
    <li>Ocupación: Técnico Mecánico Automotriz</li>
...
**ENTREVISTA 2: Técnico Independiente**
    ...
    <li>Ocupación: Técnico Automotriz</li>
